...
const electronEntryPoint = 'scripts/electron-dev-entry.js';
...
async function startProduction(): Promise<void> {
  ...
  // Open electron.
  // @ts-ignore
  const app = proc.spawn(electron, [electronEntryPoint]);
...
async function startDevelopment(): Promise<void> {
  ...
  compiler.plugin('done', (stats) => {
    ...
    // Open electron.
    // @ts-ignore
    const app = proc.spawn(electron, ['scripts/electron-dev-entry.js', '--devserver', urls.localUrlForBrowser]);
